...
[netdata ![netdata](https://img.shields.io/github/stars/firehol/netdata.svg?style=social&label=Star)](https://github.com/firehol/netdata) 是一个 Linux 实时监控工具，支持应用程序、网络状况、用户/用户组，甚至 docker/lxc 和 SNMP 的监控。
