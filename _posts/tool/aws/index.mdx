...
国内云服务参差不齐，国外却是一片欣欣向荣，曾经的 IaaS AWS 已经逐步将它的触手扩展开来，渗透进不同的领域，在 IaaS、PaaS、SaaS、DaaS 领域均有涉及，现在已经是国外创业者的首选平台。Hacker News 上有一篇评分非常高的一个 AWS 介绍文章叫做[《Amazon Web Services in Plain English》](https://www.expeditedssl.com/aws-in-plain-english)，这里简单做一下搬运。
