...
埋头死干一直不是我的风格，所以在比较 Vagrant 安装、下载期间细细阅读了多篇相关文章，其中当然少不了 Vagrant 和 Docker 作者在 [StackOverflow](http://stackoverflow.com/questions/16647069/) 上的亲自解惑（[中文](http://www.cnblogs.com/vikings-blog/p/3973265.html)）。
